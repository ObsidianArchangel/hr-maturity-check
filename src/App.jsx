...
const BLOCKS = [
  {
    ...
    questionHelpers: [
      ...
      },
      {
        ...
        howToRate: "Поставьте 3, если роли описаны в регламенте; 4 — если по ним есть матрица ответственности (RACI) и она применяется.",
      },
      {
      ...
      },
      {
        ...
        howToRate: "Поставьте 3, если пересмотр происходит хотя бы раз в полгода; 4 — если решения подкреплены данными воронки.",
      },
    ],
    metrics: [
      {
  ...
  },
  {
    ...
    questionHelpers: [
      ...
      },
      {
        ...
        howToRate: "Поставьте 3, если роли закреплены в регламенте; 4 — если граница ответственности проверяется на встречах.",
      },
      {
        check: "Готова ли поддержка к первому рабочему дню.",
        howToRate: "Поставьте 3, если наставник назначается до выхода; 4 — если у наставника есть подготовка и план встреч.",
      },
      {
        check: "Отслеживается ли динамика адаптации в фиксированные моменты.",
        howToRate: "Поставьте 3, если все три встречи проходят регулярно; 4 — если их итоги приводят к корректировкам плана.",
      },
      {
    ...
    questionHelpers: [
      {
        ...
        howToRate: "Поставьте 3, если карты существуют по всем основным направлениям; 4 — если они регулярно обновляются.",
      },
      {
      ...
      },
      {
        ...
        howToRate: "Поставьте 3, если пересмотр происходит регулярно; 4 — если изменения подкрепляются обратной связью команд.",
      },
    ],
    metrics: [
      {
  ...
  },
  {
    ...
    questionHelpers: [
      ...
      },
      {
        ...
        howToRate: "Поставьте 3, если утилизация считается регулярно; 4 — если по ней принимаются управленческие решения.",
      },
      {
      ...
      },
      {
        ...
        howToRate: "Поставьте 3, если интервью проводятся по шаблону; 4 — если их результаты обобщаются и обсуждаются с руководителями.",
      },
      {
        check: "Превращаются ли сигналы об уходе в управленческие изменения.",
        howToRate: "Поставьте 3, если изменения вносятся периодически; 4 — если их эффект отслеживается по данным.",
      },
    ],
    metrics: [
      {
  ...
  },
  {
    ...
    questionHelpers: [
      ...
      },
      {
        ...
        howToRate: "Поставьте 3, если панель существует; 4 — если она обновляется в установленные сроки и доступна руководителям.",
      },
      {
      ...
      },
      {
        ...
        howToRate: "Поставьте 3, если обсуждение происходит регулярно; 4 — если по итогам принимаются и фиксируются решения.",
      },
    ],
    metrics: [
      {
